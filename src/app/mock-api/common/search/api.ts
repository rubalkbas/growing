...
import { ittivaNavigationItem, ittivaNavigationService } from '@ittiva/components/navigation';
...
export class SearchMockApi
{
     ...
     */
    constructor(
        private _IttivaMockApiService: IttivaMockApiService,
    ...
    registerHandlers(): void
    {
        ...
        const flatNavigation = this._ittivaNavigationService.getFlatNavigation(this._defaultNavigation);
