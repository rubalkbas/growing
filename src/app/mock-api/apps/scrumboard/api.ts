...
import { IttivaMockApiService, ittivaMockApiUtils } from '@ittiva/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._IttivaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newList.id = ittivaMockApiUtils.guid();
        ...
        this._IttivaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newCard.id = ittivaMockApiUtils.guid();
        ...
        this._IttivaMockApiService
            ...
            .reply(({request}) =>
            {
                ...
                // Generate a new GUID
                newLabel.id = ittivaMockApiUtils.guid();
