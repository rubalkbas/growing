...
@Component({
    ...
    templateUrl: './ver-ticket.modal.component.html',
    styleUrls: ['./ver-ticket.modal.component.scss'],
    standalone: true,
    imports: [
        CommonModule,
        MatDialogModule,
...
export class ModalVerTicket implements OnInit {
    ...
    constructor(
        public dialogRef: MatDialogRef<ModalVerTicket>,
