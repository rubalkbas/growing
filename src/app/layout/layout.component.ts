...
import { ittivaConfig, ittivaConfigService } from '@ittiva/services/config';
...
import { ittiva_VERSION } from '@ittiva/version/ittiva-version';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _ittivaConfigService: ittivaConfigService,
        private _ittivaMediaWatcherService: ittivaMediaWatcherService,
        private _ittivaPlatformService: ittivaPlatformService,
    )
    {
    }
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            this._ittivaConfigService.config$,
            this._ittivaMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)']),
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'ittiva-version', ittiva_VERSION);

        // Set the OS name
        this._renderer2.addClass(this._document.body, this._ittivaPlatformService.osName);
    }
