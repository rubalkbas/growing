...
@Component({
    ...
    standalone   : true,
    imports      : [ittivaLoadingBarComponent, ittivaVerticalNavigationComponent, UserComponent, MatButtonModule, MatIconModule, LanguagesComponent, ittivaFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, NgIf, RouterOutlet, QuickChatComponent],
})
