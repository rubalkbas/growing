...
@Component({
    ...
    standalone   : true,
    imports      : [ittivaLoadingBarComponent, MatButtonModule, MatIconModule, LanguagesComponent, ittivaFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, NgIf, RouterOutlet, QuickChatComponent, ittivaVerticalNavigationComponent],
})
