...
@Component({
    ...
    standalone   : true,
    imports      : [ittivaLoadingBarComponent, ittivaVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, ittivaFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, NgIf, RouterOutlet, QuickChatComponent],
})
