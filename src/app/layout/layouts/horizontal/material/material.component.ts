...
@Component({
    ...
    standalone   : true,
    imports      : [ittivaLoadingBarComponent, NgIf, ittivaVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, ittivaFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, ittivaHorizontalNavigationComponent, RouterOutlet],
})
