...
@Component({
    ...
    standalone   : true,
    imports      : [ittivaLoadingBarComponent, NgIf, ittivaVerticalNavigationComponent, ittivaHorizontalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, ittivaFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, RouterOutlet],
})
