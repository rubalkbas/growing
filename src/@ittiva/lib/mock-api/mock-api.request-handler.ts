...
import { ittivaMockApiReplyCallback } from '@ittiva/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class ittivaMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: ittivaMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: ittivaMockApiReplyCallback): void
    {
        // Store the reply
