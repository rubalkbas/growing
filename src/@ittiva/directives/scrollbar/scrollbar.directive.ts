...
import { ScrollbarGeometry, ScrollbarPosition } from '@ittiva/directives/scrollbar/scrollbar.types';
 ...
 */
@Directive({
    selector  : '[ittivaScrollbar]',
    exportAs  : 'ittivaScrollbar',
    standalone: true,
})
export class ittivaScrollbarDirective implements OnChanges, OnInit, OnDestroy
{
    /* eslint-disable @typescript-eslint/naming-convention */
    static ngAcceptInputType_ittivaScrollbar: BooleanInput;
    /* eslint-enable @typescript-eslint/naming-convention */

    @Input() ittivaScrollbar: boolean = true;
    @Input() ittivaScrollbarOptions: PerfectScrollbar.Options;
    ...
    {
        // Enabled
        if ( 'ittivaScrollbar' in changes )
        {
            // Interpret empty string as 'true'
            this.ittivaScrollbar = coerceBooleanProperty(changes.ittivaScrollbar.currentValue);

            // If enabled, init the directive
            if ( this.ittivaScrollbar )
            {
                this._init();
            }
        ...
        // Scrollbar options
        if ( 'ittivaScrollbarOptions' in changes )
        {
            // Merge the options
            this._options = merge({}, this._options, changes.ittivaScrollbarOptions.currentValue);
