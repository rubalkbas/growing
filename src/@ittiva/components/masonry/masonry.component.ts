...
@Component({
    selector     : 'ittiva-masonry',
    templateUrl  : './masonry.component.html',
    encapsulation: ViewEncapsulation.None,
    animations   : ittivaAnimations,
    exportAs     : 'ittivaMasonry',
    standalone   : true,
    imports      : [NgTemplateOutlet],
})
export class ittivaMasonryComponent implements OnChanges, AfterViewInit
{
     ...
     * Constructor
     */
    constructor(private _ittivaMediaWatcherService: ittivaMediaWatcherService)
    {
    }
