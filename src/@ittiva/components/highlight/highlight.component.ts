...
import { ittivaHighlightService } from '@ittiva/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[ittiva-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'ittivaHighlight',
    standalone     : true,
    imports        : [NgClass],
})
export class ittivaHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _ittivaHighlightService: ittivaHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._ittivaHighlightService.highlight(this.code, this.lang));
